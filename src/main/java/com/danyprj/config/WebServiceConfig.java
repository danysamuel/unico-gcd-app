...
public class WebServiceConfig extends WsConfigurerAdapter {
    ...
    public DefaultWsdl11Definition defaultWsdl11Definition(XsdSchema gcdSchema) {
        ...
        wsdl11Definition.setTargetNamespace("http://danyprj.com/models/soap/gcd");
    ...
    public XsdSchema gcdSchema() {
        return new SimpleXsdSchema(new ClassPathResource("gcdsoap.xsd"));
    }
}
